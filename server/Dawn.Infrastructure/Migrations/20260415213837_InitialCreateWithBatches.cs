...
{
    /// <inheritdoc />
    public partial class InitialCreateWithBatches : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrefEmailNotif = table.Column<bool>(type: "bit", nullable: false),
                    PrefInAppNotif = table.Column<bool>(type: "bit", nullable: false),
                    PrefSessions = table.Column<bool>(type: "bit", nullable: false),
                    PrefAssignments = table.Column<bool>(type: "bit", nullable: false),
                    PrefAnnouncements = table.Column<bool>(type: "bit", nullable: false),
                    PrefOthers = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "SemesterInvoices",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AmountNpr = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    DueDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsPaid = table.Column<bool>(type: "bit", nullable: false),
                    PaidAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ESewaTransactionId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ESewaReceiptUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SemesterInvoices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SemesterInvoices_AspNetUsers_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentSessionLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentSessionLogs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AttendanceRecords_Courses_ModuleId",
                        column: x => x.ModuleId,
                        principalTable: "Courses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PptUrl = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Order = table.Column<int>(type: "int", nullable: false),
                    CompletionWeight = table.Column<int>(type: "int", nullable: false),
                    CourseId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    CourseId = table.Column<int>(type: "int", nullable: true),
                    SemesterInvoiceId = table.Column<int>(type: "int", nullable: true),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ...
                    InstructorEarning = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentRecords_AspNetUsers_StudentId",
                        column: x => x.StudentId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PaymentRecords_SemesterInvoices_SemesterInvoiceId",
                        column: x => x.SemesterInvoiceId,
                        principalTable: "SemesterInvoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradedByInstructorId = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceRecords_ModuleId",
                table: "AttendanceRecords",
                column: "ModuleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentRecords_SemesterInvoiceId",
                table: "PaymentRecords",
                column: "SemesterInvoiceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SemesterInvoices_StudentId",
                table: "SemesterInvoices",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentSessionLogs_UserId",
                table: "StudentSessionLogs",
                column: "UserId");
